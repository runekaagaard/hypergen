...
def link_sta(*children, **attrs):
    return element_start("link", children, **attrs)


def link_end(*children, **kwargs):
    return element_end("link", children, **kwargs)


def link_ret(*children, **kwargs):
    return element_ret("link", children, **kwargs)


@contextmanager
def link_con(*children, **attrs):
    for x in element_con("link", children, **attrs):
        yield x


def link_dec(*children, **attrs):
    return element_dec("link", children, **attrs)


def link(*children, **attrs):
    return element("link", children, **attrs)
